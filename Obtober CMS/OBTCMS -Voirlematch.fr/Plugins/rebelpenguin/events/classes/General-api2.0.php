...
/*----------------Livegoals ---- API-Service---------------------*/

    static function sportservice($date,$sport)
    {
        //$weburlserv = "http://163.172.20.91/api/v2.0/schedule/".$date."?sport=".$sport."&locale=".self::$locale;
        $weburlserv = "http://163.172.20.91/api/v2.0/schedule/".$date."?sport=".$sport."&locale=".self::$locale."&options=streams&rank=999";
    ...
    {
        /*$weburlserv = "http://163.172.20.91/api/v2.0/schedule/";*/
        $sport=template::sport_name();
        $date=date("Y-m-d");
        //$weburlserv = "http://163.172.20.91/api/v2.0/schedule/".$date."?sport=".$sport[0]['id_sport']."&locale=".self::$locale;
        $weburlserv = "http://163.172.20.91/api/v2.0/schedule/".$date."?sport=".$sport[0]['id_sport']."&locale=".self::$locale."&options=streams&rank=999";
        $client = curl_init($weburlserv);
        curl_setopt($client, CURLOPT_RETURNTRANSFER, true);
        $respon = curl_exec($client);
    ...
    static function service_fodbold_stramp($id)
    {
        ...
        $weburlserv = "http://163.172.20.91/api/v2.0/event/".$id."/streams";
        $client = curl_init($weburlserv);
        curl_setopt($client, CURLOPT_RETURNTRANSFER, true);
        $respon = curl_exec($client);
        $result = (array)json_decode($respon);
    ...
    static function service_fodbold_odds($id)
    {
        ...
        $weburlserv = "http://163.172.20.91/api/v2.0/event/".$id."/odds";
        $client = curl_init($weburlserv);
        curl_setopt($client, CURLOPT_RETURNTRANSFER, true);
        $respon = curl_exec($client);
        $result = (array)json_decode($respon);
    ...
    static function service_event($id)
    {
       /* $weburlserv = "http://web1.livegoals.dk:9255/api/v1.1/event/".$id."?locale=".self::$locale;*/
        $weburlserv = "http://163.172.20.91/api/v2.0/event/".$id."?locale=".self::$locale;
        //var_dump($weburlserv);
        $client = curl_init($weburlserv);
        curl_setopt($client, CURLOPT_RETURNTRANSFER, true);
        $respon = curl_exec($client);
    ...
    {
        $weburlserv = "http://163.172.20.91/api/v2.0/stream_provider/list";
        $client = curl_init($weburlserv);
        curl_setopt($client, CURLOPT_RETURNTRANSFER, true);
        $respon = curl_exec($client);
        $result = (array)json_decode($respon);
    ...
    static function Service_Sport()
    {
        ...
        $weburlserv = "http://163.172.20.91/api/v2.0/sport/list?locale=".self::$locale;
        $client = curl_init($weburlserv);
        curl_setopt($client, CURLOPT_RETURNTRANSFER, true);
        $respon = curl_exec($client);
        $result = (array)json_decode($respon);
    ...
    {
        $weburlserv = "http://163.172.20.91/api/v2.0/region/list?locale=".self::$locale;
        //$weburlserv = "http://163.172.20.91/api/v2.0/region/list?locale=en&version=1";
        $client = curl_init($weburlserv);
        curl_setopt($client, CURLOPT_RETURNTRANSFER, true);
        $respon = curl_exec($client);
        $arreglo = (array)json_decode($respon);
    ...
    {
        $weburlserv = "http://163.172.20.91/api/v2.0/competition/list?region=".$region."&sport=".$sport;
...
/*----------------ContentRebelPenguin   ---  API-Service---------------------*/
